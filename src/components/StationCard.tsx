  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 flex-shrink-0 relative z-10">
        ...
        <span
          className="text-[10px] px-2 py-0.5 rounded-full font-semibold tracking-wide hidden sm:inline-block border border-white/10"
          style={{ background: `${station.color}1c`, color: station.color }}
        >
          {station.genre}
        </span>
